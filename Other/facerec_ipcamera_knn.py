...
if __name__ == "__main__":
    ...
    classifier = train('D:\\[0]PyScript\\ipcam_recg\\knn_examples\\train', model_save_path="D:\\[0]PyScript\\ipcam_recg\\knn_examples\\train\\trained_knn_model.clf", n_neighbors=2)
    print("Training complete!")
    # process one frame in every 30 frames for speed
    process_this_frame = 1
    print('Setting cameras up...')
    # multiple cameras can be used with the format url = 'http://username:password@camera_ip:port'
    url = 'rtsp://admin:P@$$w0rd@192.168.1.245:554/cam/realmonitor?channel=1&subtype=1'
    ...
    while 1 > 0:
        ...
        if ret:
            ...
            if process_this_frame % 1 == 0:
                predictions = predict(img, model_path="D:\\[0]PyScript\\ipcam_recg\\knn_examples\\train\\trained_knn_model.clf")
            print(predictions)
